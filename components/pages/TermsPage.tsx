  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-lg animate-fade-in">
      ...
      <div className="space-y-6 text-base leading-relaxed text-gray-700">
        <h1 className="text-4xl font-bold text-gray-800 border-b pb-4">നിബന്ധനകളും വ്യവസ്ഥകളും</h1>
        <p>
        ...
        <h2 className="text-2xl font-bold text-gray-800">1. ഉപയോഗത്തിനുള്ള അനുമതി</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-gray-800">2. ഉള്ളടക്കത്തിന്റെ കൃത്യത</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-gray-800">3. ബാഹ്യ ലിങ്കുകൾ</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-gray-800">4. ബാധ്യതയുടെ പരിമിതി</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-gray-800">5. മാറ്റങ്ങൾ</h2>
        <p>
