    ...
    return (
        <div className="animate-fade-in">
            ...
            <header className="mb-8 text-center border-b border-slate-200 pb-6">
                ...
                <p className="text-lg text-slate-600 mt-2 max-w-2xl mx-auto">പരീക്ഷകൾക്ക് ചോദിക്കാൻ സാധ്യതയുള്ള പ്രധാന വസ്തുതകൾ.</p>
            </header>

            {loading ? (
                <div className="flex flex-col items-center justify-center py-20">
                    <div className="w-10 h-10 border-4 border-yellow-200 border-t-yellow-500 rounded-full animate-spin"></div>
                    <p className="mt-4 text-lg text-slate-600">വിവരങ്ങൾ ശേഖരിക്കുന്നു...</p>
                </div>
            ) : error ? (
