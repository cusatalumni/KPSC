  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-lg animate-fade-in">
      ...
      <div className="space-y-6 text-lg leading-relaxed text-gray-700">
        <h1 className="text-4xl font-bold text-gray-800 border-b pb-4">ഞങ്ങളെക്കുറിച്ച്</h1>
        <p>
        ...
        <h2 className="text-2xl font-bold text-gray-800">ഞങ്ങളുടെ ലക്ഷ്യം</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-gray-800">എന്തുകൊണ്ട് ഞങ്ങൾ?</h2>
