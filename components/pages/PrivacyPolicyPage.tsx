  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-lg animate-fade-in">
      ...
      <div className="space-y-6 text-base leading-relaxed text-gray-700">
        <h1 className="text-4xl font-bold text-gray-800 border-b pb-4">പ്രൈവസി പോളിസി</h1>
        <p>
        ...
        <h2 className="text-2xl font-bold text-gray-800">ഞങ്ങൾ ശേഖരിക്കുന്ന വിവരങ്ങൾ</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-gray-800">വിവരങ്ങളുടെ ഉപയോഗം</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-gray-800">വിവരങ്ങളുടെ സംരക്ഷണം</h2>
        <p>
          നിങ്ങളുടെ വ്യക്തിഗത വിവരങ്ങളുടെ സുരക്ഷ നിലനിർത്തുന്നതിനായി ഞങ്ങൾ വിവിധ സുരക്ഷാ നടപടികൾ സ്വീകരിക്കുന്നു.
        </p>
        <h2 className="text-2xl font-bold text-gray-800">കുക്കികളുടെ ഉപയോഗം</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-gray-800">മാറ്റങ്ങൾ</h2>
        <p>
