                        ...
                        <div className="relative">
                            ...
                            <div className="absolute top-1/2 -left-4 md:-left-20 -translate-y-1/2">
                                <button 
                                    ...
                                    className={`p-4 rounded-full shadow-2xl transition-all ${currentIndex === 0 ? 'bg-slate-100 text-slate-300 cursor-not-allowed' : 'bg-white dark:bg-slate-900 text-indigo-600 hover:scale-110 active:scale-95'}`}
                                >
                            ...
                            <div className="absolute top-1/2 -right-4 md:-right-20 -translate-y-1/2">
                                <button 
                                    ...
                                    className={`p-4 rounded-full shadow-2xl transition-all ${currentIndex === filtered.length - 1 && !hasMore ? 'bg-slate-100 text-slate-300 cursor-not-allowed' : 'bg-white dark:bg-slate-900 text-indigo-600 hover:scale-110 active:scale-95'}`}
                                >
                                    <div className="rotate-180"><ChevronLeftIcon className="h-8 w-8" /></div>
                                </button>
                            </div>
                        </div>
