    ...
    return (
        <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
            <div className="flex items-center space-x-3 mb-4">
                ...
                <h4 className="text-xl font-bold text-gray-800">പഠന സാമഗ്രികൾ</h4>
            </div>
            <div className="space-y-2">
             ...
             <button className="mt-4 w-full text-center bg-blue-50 text-blue-700 font-semibold px-4 py-2 rounded-lg hover:bg-blue-100 transition duration-200">
                എല്ലാം കാണുക
            </button>
        </div>
    );
